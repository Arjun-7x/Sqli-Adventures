...
Same goal as Lab 8 — map the whole database and pull credentials from nothing — but Oracle keeps its metadata somewhere different. No `information_schema` here; Oracle uses its own system views, `all_tables` and `all_tab_columns`, to expose the same information.
...
![Confirming two text-capable columns via dual](images/lab9-step1-column-check.png)
...
![Full table listing from all_tables](images/lab9-step2-tables.png)
...
![Column listing from all_tab_columns](images/lab9-step3-columns.png)
